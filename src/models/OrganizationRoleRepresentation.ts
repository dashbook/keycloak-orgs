 ...
 */
export function instanceOfOrganizationRoleRepresentation(value: object): boolean {
    return true;
}
...
export function OrganizationRoleRepresentationToJSON(value?: OrganizationRoleRepresentation | null): any {
    if (value == null) {
        return value;
    }
    return {
