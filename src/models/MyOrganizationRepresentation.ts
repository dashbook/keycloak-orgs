 ...
 */
export function instanceOfMyOrganizationRepresentation(value: object): boolean {
    return true;
}
...
export function MyOrganizationRepresentationToJSON(value?: MyOrganizationRepresentation | null): any {
    if (value == null) {
        return value;
    }
    return {
