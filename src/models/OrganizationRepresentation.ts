 ...
 */
export function instanceOfOrganizationRepresentation(value: object): boolean {
    return true;
}
...
export function OrganizationRepresentationToJSON(value?: OrganizationRepresentation | null): any {
    if (value == null) {
        return value;
    }
    return {
