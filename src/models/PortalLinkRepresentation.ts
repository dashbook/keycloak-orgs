 ...
 */
export function instanceOfPortalLinkRepresentation(value: object): boolean {
    return true;
}
...
export function PortalLinkRepresentationToJSON(value?: PortalLinkRepresentation | null): any {
    if (value == null) {
        return value;
    }
    return {
