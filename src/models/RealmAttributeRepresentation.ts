 ...
 */
export function instanceOfRealmAttributeRepresentation(value: object): boolean {
    return true;
}
...
export function RealmAttributeRepresentationToJSON(value?: RealmAttributeRepresentation | null): any {
    if (value == null) {
        return value;
    }
    return {
